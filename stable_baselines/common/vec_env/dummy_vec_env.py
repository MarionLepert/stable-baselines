...
class DummyVecEnv(VecEnv):
    ...
    def __init__(self, env_fns):
        ...
        self.buf_objState = np.zeros((self.num_envs,6))
    ...
    def step_wait(self):
        for env_idx in range(self.num_envs):
            obs, self.buf_rews[env_idx], self.buf_dones[env_idx], self.buf_infos[env_idx], self.buf_objState[env_idx]=\
        ...
        return (self._obs_from_buf(), np.copy(self.buf_rews), np.copy(self.buf_dones),
                deepcopy(self.buf_infos), np.copy(self.buf_objState))
